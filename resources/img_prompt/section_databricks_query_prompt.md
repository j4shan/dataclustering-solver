...
`project_metadata/instructions/lakehouse-plate-system.md`. That document is
the single source for the substrate, the two role hues and their measured
...
one for this plate alone — a change to the look is a change to that document and
